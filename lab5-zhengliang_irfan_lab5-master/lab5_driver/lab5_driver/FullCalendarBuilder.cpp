...
std::shared_ptr<Calendar> FullCalendarBuilder::buildCalendar_from_restore(std::string name, size_t years, int tm_start_year, int tm_wday)
{
	currentCalendar = make_shared<Calendar>(name, years);
...
shared_ptr<Event> FullCalendarBuilder::buildEvent(shared_ptr<DisplayableComponent> cal, string name, tm when, int recurrEvery, int recurrFor) {
